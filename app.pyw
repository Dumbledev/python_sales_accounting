...
def home():
    ...
    monthly_sale = Sale.all()
    return render_template("home.html", user=user[0], sales=monthly_sale)
...
def admin():
    ...
    return render_template("admin/admin.html", user=user[0], all_products=all_products, 
                           ...
                           m_product_entries=m_product_entries)
...
def product_entries():
    ...
    return render_template("admin/product_entries.html", products=products, user=user, entries=product_entries)
